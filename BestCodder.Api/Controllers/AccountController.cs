...
{   
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> 
            userManager, RoleManager<IdentityRole> roleManager, ITokenService tokenService)
        {
        ...
        public async Task<IActionResult> SignIn([FromBody] SignInDto signInDto)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (user is null)
                    return Unauthorized(new Result<IActionResult>(false,
                        ResultConstant.InvalidAuthentication));
